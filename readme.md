...
1. Head to releases and flash `microbit-komoot-pair.hex` onto your microbit by dragging and dropping. This is the program we will use to pair with your phone.
...
5. Go to releases and flash `microbit-komoot-navigator.hex` onto your microbit by dragging and dropping. This is the program that acts as the navigator.
